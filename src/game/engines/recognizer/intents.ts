...
export const INTENTS: readonly IntentSpec[] = [
  ...
  // ------------------------------------------------------- Poder e ordem
  // Estas intenções não viram medida: elas ABREM o painel de poder, porque
  // mobilizar tropa, decretar exceção ou declarar guerra são decisões que o
  // jogo faz o presidente olhar no olho antes de executar.
  {
    id: 'mobilizar_militares',
    label: 'Mobilização militar',
    phrases: [
      'mobilizar o exercito',
      'mobilizar as tropas',
      'mobilizar as forcas armadas',
      'colocar o exercito na rua',
      'convocar as forcas armadas',
      'aumentar a prontidao militar',
    ],
    verbs: ['mobiliz', 'convoc', 'colocar na rua', 'acionar'],
    objects: ['exercito', 'tropa', 'forcas armadas', 'militares', 'quartel'],
    expects: [],
    builder: 'poder',
    alwaysConfigure: true,
    category: 'seguranca',
  ...
  {
    id: 'estado_de_excecao',
    label: 'Estado de exceção',
    phrases: [
      'declarar estado de emergencia',
      'declarar estado de excecao',
      'estado de sitio',
      'decretar estado de excecao',
      'colocar o pais em estado de excecao',
      'poderes extraordinarios',
      'estado de defesa',
    ],
    verbs: ['declarar', 'decretar', 'instituir', 'colocar'],
    objects: ['estado de excecao', 'estado de emergencia', 'estado de sitio', 'estado de defesa'],
    expects: [],
    builder: 'poder',
    alwaysConfigure: true,
  ...
  {
    id: 'aumentar_repressao',
    label: 'Controle das manifestações',
    phrases: [
      'aumentar a repressao',
      'reprimir os protestos',
      'acabar com as manifestacoes',
      'endurecer com os manifestantes',
      'controlar as manifestacoes',
    ],
    verbs: ['reprimir', 'repressao', 'endurecer', 'controlar', 'dispersar', 'conter'],
    objects: ['protesto', 'manifestacao', 'manifestante', 'greve', 'rua', 'desordem'],
    expects: [],
    builder: 'poder',
    alwaysConfigure: true,
    category: 'seguranca',
  ...
  },
  {
    ...
    phrases: [
      ...
      'assumir poderes totais',
      'acabar com a democracia',
      'transicao democratica',
      'redemocratizar o pais',
    ],
    verbs: ['fechar', 'dissolver', 'assumir', 'romper', 'redemocratiz'],
    objects: ['congresso', 'democracia', 'ditadura', 'golpe', 'regime', 'poderes totais'],
    expects: [],
    builder: 'poder',
    alwaysConfigure: true,
    category: 'institucional',
  ...
  {
    id: 'declarar_guerra',
    label: 'Declaração de guerra',
    phrases: [
      'declarar guerra',
      'entrar em guerra',
      'atacar militarmente',
      'romper relacoes e atacar',
      'guerra contra',
    ],
    verbs: ['declarar guerra', 'entrar em guerra', 'atacar', 'invadir', 'bombardear'],
    objects: ['guerra', 'conflito armado', 'ataque militar'],
    expects: ['COUNTRY'],
    builder: 'poder',
    alwaysConfigure: true,
    category: 'diplomacia',
    ministries: ['defesa', 'relacoes_exteriores'],
    specificity: 99,
  },
  {
    id: 'negociar_paz',
    label: 'Negociação de paz',
    phrases: ['negociar a paz', 'acordo de paz', 'cessar fogo', 'encerrar a guerra', 'fazer as pazes'],
    verbs: ['negociar', 'encerrar', 'assinar', 'buscar'],
    objects: ['paz', 'cessar fogo', 'armisticio', 'guerra'],
    expects: ['COUNTRY'],
    builder: 'poder',
    alwaysConfigure: true,
    category: 'diplomacia',
