import type { CandidateProfile, MinistryId } from '../types/index';
...
export const MINISTER_POOL: readonly MinisterCandidate[] = [
  // --- Técnicos ---
  {
    id: 'min_t1', name: 'Helena Vasconcelos', party: null, kind: 'tecnico',
  ...
  {
    id: 'min_t2', name: 'Dr. Nelson Aragão', party: null, kind: 'tecnico',
  ...
  {
    id: 'min_t3', name: 'Professora Marisa Delgado', party: null, kind: 'tecnico',
  ...
  {
    id: 'min_t4', name: 'Eng. Rogério Klein', party: null, kind: 'tecnico',
  ...
  {
    id: 'min_t5', name: 'Embaixadora Teresa Iglesias', party: null, kind: 'tecnico',
  ...
  {
    id: 'min_t6', name: 'Delegada Simone Falcão', party: null, kind: 'tecnico',
  ...
  {
    id: 'min_t7', name: 'Gal. Sebastião Dantas', party: null, kind: 'tecnico',
  ...
  {
    id: 'min_t8', name: 'Dra. Fabiana Rezende', party: null, kind: 'tecnico',
  ...
  {
    id: 'min_t9', name: 'Amanda Nogueira', party: null, kind: 'tecnico',
  ...
  {
    id: 'min_t10', name: 'Leandro Bastos', party: null, kind: 'tecnico',
  ...
  // --- Políticos ---
  {
    id: 'min_p1', name: 'Genival Macedo', party: 'PP', kind: 'politico',
  ...
  {
    id: 'min_p2', name: 'Vanessa Camargo', party: 'UNIÃO', kind: 'politico',
  ...
  {
    id: 'min_p3', name: 'Cássio Valadares', party: 'MDB', kind: 'politico',
  ...
  {
    id: 'min_p4', name: 'Pastor Edmilson Tavares', party: 'REPUBLICANOS', kind: 'politico',
  ...
  {
    id: 'min_p5', name: 'Beatriz Lacerda', party: 'PT', kind: 'politico',
  ...
  {
    id: 'min_p6', name: 'Tarcísio Guimarães', party: 'PL', kind: 'politico',
  ...
  {
    id: 'min_p7', name: 'Jussara Wanderley', party: 'PSB', kind: 'politico',
  ...
  {
    id: 'min_p8', name: 'Valdir Quadros', party: 'PSD', kind: 'politico',
  ...
  // --- Independentes / mídia ---
  {
    id: 'min_i1', name: 'Renata Escobar', party: null, kind: 'independente',
  ...
  {
    id: 'min_i2', name: 'Danilo Peixoto', party: null, kind: 'internet',
  ...
  {
    id: 'min_i3', name: 'Aline Sarmento', party: null, kind: 'independente',
  ...
  {
    id: 'min_i4', name: 'Hélio Zamboni', party: null, kind: 'independente',
