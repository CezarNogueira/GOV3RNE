...
export const AGENDA_ACTIONS: readonly AgendaAction[] = [
  ...
  },
  {
    ...
    description: 'Chamar o titular, cobrar entrega e decidir se ele fica.',
    cost: 1,
    energyCost: 5,
    category: 'articulacao',
    consequence: 'Aumenta a entrega da pasta e o desgaste do ministro.',
  },
  {
    id: 'reuniao_governador',
    label: 'Receber um governador',
    description: 'Estado por estado. Quem sai da sala com verba sai defendendo o governo.',
    cost: 2,
    energyCost: 6,
    category: 'articulacao',
    consequence: 'Melhora a relação com o estado e a aprovação regional.',
  },
  {
    id: 'reuniao_lideres',
    label: 'Reunião com os líderes',
    description: 'Café da manhã no Alvorada com quem controla o painel de votação.',
    cost: 2,
    energyCost: 8,
    category: 'articulacao',
    consequence: 'Sobe a boa vontade geral do Congresso por alguns meses.',
  },
  {
    id: 'pronunciamento',
